            ...
            <div className="max-w-3xl mx-auto bg-[#121214] border border-zinc-900 rounded-xl p-8 shadow-2xl">
                ...
                <div className="border-b border-zinc-800 pb-6 mb-8">
                    ...
                    <div className="mt-4 inline-flex items-center gap-2 bg-zinc-900/50 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-400">
                        ...
                        Posting as:{" "}
                        <span className="font-semibold text-zinc-300">{mockCompany.name}</span>
                    ...
                    <Fieldset className="space-y-6 w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col gap-1 w-full">
                                <Select
                                    ...
                                    name="jobCategory"
                                    selectedKeys={jobCategory ? [jobCategory] : []}
                                    onSelectionChange={(keys) => setJobCategory([...keys][0] ?? "")}
                                ...
                                {errors.jobCategory && (
                                    <span className="text-xs text-danger mt-1">{errors.jobCategory}</span>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col gap-1 w-full">
                                ...
                                {errors.jobType && (
                                    <span className="text-xs text-danger mt-1">{errors.jobType}</span>
                                )}
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                ...
                                <Select
                                    ...
                                    onSelectionChange={(keys) => setCurrency([...keys][0] ?? "USD")}
                                >
                                    <Select.Trigger className={triggerClasses}>
                                        <Select.Value />
                                        <Select.Indicator />
